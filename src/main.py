...
def main(args: argparse.Namespace = get_args()) -> None:
    ...
    def save_best_fn(fn: Algorithm) -> None:
        torch.save(fn.state_dict(), os.path.join(log_path, "policy.pth"))
    ...
    def watch() -> None:
        ...
        if args.save_buffer_name:
            ...
            collector = Collector[CollectStats](
                algorithm, test_envs, replay, exploration_noise=True
            )
            data = collector.collect(n_step=args.buffer_size, reset_before_collect=True)
            ...
            data = test_collector.collect(n_episode=args.num_test_envs, render=args.render)
        data.pprint_asdict()
